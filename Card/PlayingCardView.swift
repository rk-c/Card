...
class PlayingCardView: UIView {
    ...
    override func layoutSubviews() {
        ...
        lowerRightCornerLable.transform = CGAffineTransform.identity.translatedBy(x: lowerRightCornerLable.frame.size.width, y: lowerRightCornerLable.frame.size.height)
...
extension PlayingCardView {
    private struct SizeRatio {
        static let cornerFontSizeToBoundsHeght: CGFloat = 0.085
        static let cornerRadiusToBoundsHeght: CGFloat = 0.06
        static let cornerOffsetToCornerRadius: CGFloat = 0.33
        static let faceCardImageSizeToBoundsSize: CGFloat = 0.75
    }
    private var cornerRadius: CGFloat {
        return bounds.size.height * SizeRatio.cornerRadiusToBoundsHeght
    }
    private var cornerOffset: CGFloat {
        return cornerRadius * SizeRatio.cornerOffsetToCornerRadius
    }
    private var cornerFontSize: CGFloat {
        return bounds.size.height * SizeRatio.cornerFontSizeToBoundsHeght
    }
...
extension CGRect {
    ...
    var rightHalf: CGRect {
        return CGRect(x: maxX, y: minY, width: width/2, height: height)
    }
